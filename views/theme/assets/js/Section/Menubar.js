      ...
      value: function setupMenu() {
        if (typeof _jquery2.default.fn.mmenu !== 'undefined') {
          this.$el.mmenu({
            ...
            navbars: [{
              position: 'bottom',
              content: ['<div class="site-menubar-footer">\n              <a href="'+$('#mi_perfil').attr('href')+'" class="fold-show" data-placement="top" data-toggle="tooltip" data-original-title="Configuración">\n                <span class="icon wb-settings" aria-hidden="true"></span>\n              </a>\n              <a href="'+$('#frontend').data('val')+'" data-placement="top" data-toggle="tooltip" data-original-title="Frontend">\n                <span class="icon wb-eye-close" aria-hidden="true"></span>\n              </a>\n              <a href="logout/" data-placement="top" data-toggle="tooltip" data-original-title="Salir">\n                <span class="icon wb-power" aria-hidden="true"></span>\n              </a>\n            </div>']
            }]
          });
        }
      }
